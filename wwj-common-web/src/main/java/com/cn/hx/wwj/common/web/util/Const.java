...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(sms)|(gateway)|(code)|(app)|(doll)|(weixin)|(static)|(main)|(DollImage)|(websocket)|(uploadImgs)).*";	//不对匹配该值的访问路径拦截（正则）
