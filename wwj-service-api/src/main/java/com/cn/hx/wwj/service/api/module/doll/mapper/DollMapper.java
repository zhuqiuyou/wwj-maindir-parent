package com.cn.hx.wwj.service.api.module.doll.mapper;
...
public interface DollMapper{
	 ...
	 * @throws Exception
	 */
	public List<PageData> dolllistPage(Page page)throws Exception;
	
	/**列表(全部)
	 * @param pd
	 * @throws Exception
	 */
	public List<PageData> listAlllistPage(PageData pd)throws Exception;
