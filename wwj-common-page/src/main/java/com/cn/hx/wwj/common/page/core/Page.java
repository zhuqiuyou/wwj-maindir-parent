package com.cn.hx.wwj.common.page.core;

import com.cn.hx.wwj.common.page.util.PageConst;
import com.cn.hx.wwj.common.page.util.PageTools;
...
public class Page {
	...
	public Page(){
		try {
			this.showCount = Integer.parseInt(PageTools.readTxtFile(PageConst.PAGE));
		} catch (Exception e) {
			this.showCount = 15;
		}
	}
